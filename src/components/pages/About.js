...
export const About = () => {
  ...
  return (
    <div className='About ms-4 boton nav-link fw-bold fs-3'>
      ...
      <section class="row inicio-home-background section-1-home container-fluid">

    
        <article className= "col-12 container ">
                      
          <div className="p-4 texto">
            <h1 className="text-dark fw-bold text-center m-4">INGAR</h1>
            <h3 className="text-lith fw-bold text-center">Sobre Nosotros</h3>
          </div>
       ...
       <section className="row inicio-home-background section-2-home container-fluid">
          <article className= "col-12 container ">
            ...
            <div className="p-4 texto2">
              <h1 className="text-dark fw-bold text-center m-4 ingar">Nuestras Proyecciones</h1>
